...
const colors = {
  ...
  accent: '#E6B38F',         // darker than #FFDAB9
...
const Home = () => {
  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-gradient-to-br from-sky-50 via-pink-50 to-purple-50 dark:from-slate-900 dark:via-purple-900 dark:to-indigo-900 text-gray-800 dark:text-gray-100 overflow-x-hidden transition-all duration-1000">
        ...
        <div className="absolute inset-0 z-0">
          <video
            ...
            onError={(e) => {
              ...
              e.target.parentElement.style.background = 'linear-gradient(135deg, #0F172A, #1E293B, #334155)';
            }}
          >
        ...
        >
          ...
          >
            {[
              ...
              >
                ...
                <span className="text-sm font-medium text-gray-800 dark:text-gray-200">{stat.text}</span>
              </motion.div>
            ))}
          </motion.div>
          ...
          >
            ...
            >
              ...
              <span className="font-medium text-gray-800 dark:text-gray-200">Anonymous & Safe</span>
            </motion.div>
            <motion.div 
              className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 dark:bg-gray-800/10 backdrop-blur-sm border border-white/10 dark:border-gray-700/20"
            >
              <Lightning className="w-5 h-5 text-blue-500 dark:text-blue-400" />
              <span className="font-medium text-gray-800 dark:text-gray-200">32s Avg Response</span>
            </motion.div>
            <motion.div 
              className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 dark:bg-gray-800/10 backdrop-blur-sm border border-white/10 dark:border-gray-700/20"
            >
              <AI className="w-5 h-5 text-purple-500 dark:text-purple-400" />
              <span className="font-medium text-gray-800 dark:text-gray-200">AI-Powered Support</span>
            </motion.div>
          </motion.div>
        </motion.div>
      ...
      <section ref={featuresRef} className="py-32 px-6 bg-gradient-to-br from-sky-50 via-pink-50 to-purple-50 dark:from-slate-900 dark:via-purple-900 dark:to-indigo-900 relative overflow-hidden transition-all duration-1000">
        {/* Background Elements */}
        <div className="absolute inset-0 z-0">
          <motion.div
          ...
          >
            {[
              ...
              >
                ...
                <p className="text-gray-800 dark:text-gray-100 leading-relaxed">{value.description}</p>
              </motion.div>
            ))}
          </motion.div>
        </div>
          ...
          >
            {testimonials.map((testimonial, index) => (
              ...
              >
                ...
                <p className="text-lg text-gray-900 dark:text-gray-100 italic leading-relaxed mb-4">&quot;{testimonial.quote}&quot;</p>
                <p className="text-lg font-semibold text-black dark:text-white">{testimonial.author}</p>
                <p className="text-gray-800 dark:text-gray-200">{testimonial.role}</p>
              </motion.div>
            ))}
          </motion.div>
        </div>
