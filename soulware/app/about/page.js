...
const About = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50 dark:from-slate-900 dark:via-blue-900 dark:to-purple-900 transition-all duration-1000">
      {/* Hero Section */}
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden gradient-hero dark:bg-gradient-to-br dark:from-slate-900 dark:via-blue-900 dark:to-purple-900">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="text-lg font-semibold text-gray-800 dark:text-white mb-2">Student-Focused Design</h4>
                    <p className="text-gray-600 dark:text-gray-300">Built specifically for the unique challenges and needs of student life.</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <CheckCircle className="w-6 h-6 text-green-500 mr-4 mt-1 flex-shrink-0" />
                  <div>
                    <h4 className="text-lg font-semibold text-gray-800 dark:text-white mb-2">Complete Anonymity</h4>
                    <p className="text-gray-600 dark:text-gray-300">Your privacy is protected with end-to-end encryption and anonymous options.</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <CheckCircle className="w-6 h-6 text-green-500 mr-4 mt-1 flex-shrink-0" />
                  <div>
                    <h4 className="text-lg font-semibold text-gray-800 dark:text-white mb-2">24/7 Availability</h4>
                    <p className="text-gray-600 dark:text-gray-300">Support is available whenever you need it, day or night.</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <CheckCircle className="w-6 h-6 text-green-500 mr-4 mt-1 flex-shrink-0" />
                  <div>
                    <h4 className="text-lg font-semibold text-gray-800 dark:text-white mb-2">Evidence-Based Approach</h4>
                    <p className="text-gray-600 dark:text-gray-300">All resources and methods are backed by scientific research and best practices.</p>
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <blockquote className="text-xl text-gray-700 dark:text-gray-200 italic mb-6 leading-relaxed">
              ...
              <div className="text-center">
                <p className="font-semibold text-gray-800 dark:text-white">- The Soulware Team</p>
                <p className="text-gray-600 dark:text-gray-300">Founded 2024</p>
              </div>
            </motion.div>
          </div>
        </div>
      ...
      {/* Values Section */}
      <section className="py-20 px-6 calming-blue dark:bg-gray-800 transition-all duration-1000">
        <div className="max-w-6xl mx-auto">
          <motion.div
            className="text-center mb-16"
            initial={{ opacity: 0, y: 30 }}
      ...
      {/* Team Section */}
      <section className="py-20 px-6 calming-green dark:bg-gray-800 transition-all duration-1000">
        <div className="max-w-6xl mx-auto">
          <motion.div
            className="text-center mb-16"
            initial={{ opacity: 0, y: 30 }}
