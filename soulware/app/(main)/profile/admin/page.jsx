...
export default function AdminProfileForm() {
  ...
  return (
    <form className="max-w-md mx-auto py-10 space-y-4" onSubmit={handleSubmit}>
      ...
      <input name="designation" value={form.designation} onChange={handleChange} placeholder="Designation" className="w-full border rounded px-3 py-2" required />
      <input name="permissions" value={form.permissions} onChange={handleChange} placeholder="Permissions (comma separated)" className="w-full border rounded px-3 py-2" />
